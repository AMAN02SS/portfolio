...
useEffect(() => {
  ...
  return () => observer.disconnect();
    ...
    return (
        <div>
                <div className='text-center text-white py-20 my-10' ref={ref}>
                    ...
                    <h1 className={`${LavishlyYours.className} text-[#45ff8f] text-[100px] transition-all duration-1000 ease-out will-change-[opacity,filter,transform] ${visible ? "opacity-100 blur-0 translate-y-0" : "opacity-0 blur-md translate-x-4"} delay-4000`}>Begins</h1>
                </div>
        </div>
    )
}
